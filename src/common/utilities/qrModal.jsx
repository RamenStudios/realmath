...
export const QRModal = ({url, vis, onclose}) =>
{
    console.log(`QRMODAL`)
	
    return(
        <div className="modal" id={`qrModal ${vis ? 'open' : ''}`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="qrModalLabel" aria-hidden="true">
